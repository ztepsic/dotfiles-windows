...
- [**Context7**](https://github.com/upstash/context7) ([Web](https://context7.com/))
  - Up-to-date Docs for LLMs and AI code editors. Get the latest documentation and code into Cursor, Claude, or other LLMs
  - Context7 MCP pulls up-to-date, version-specific documentation and code examples straight from the source — and places them directly into your prompt.
- Microsoft Docs
  - Give your AI assistant (Claude, Cursor, Copilot, Codex, ...) direct access to the latest official Microsoft documentation.
